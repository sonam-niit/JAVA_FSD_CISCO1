...
public class UserServiceImplServiceLocator extends org.apache.axis.client.Service implements com.cisco.soap.service.UserServiceImplService {
    ...
    private java.lang.String UserServiceImpl_address = "http://localhost:8080/SOAPDemo/services/UserServiceImpl";
    ...
    public com.cisco.soap.service.UserServiceImpl getUserServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.cisco.soap.service.UserServiceImpl getUserServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cisco.soap.service.UserServiceImplSoapBindingStub _stub = new com.cisco.soap.service.UserServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cisco.soap.service.UserServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cisco.soap.service.UserServiceImplSoapBindingStub _stub = new com.cisco.soap.service.UserServiceImplSoapBindingStub(new java.net.URL(UserServiceImpl_address), this);
                _stub.setPortName(getUserServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.soap.cisco.com", "UserServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.soap.cisco.com", "UserServiceImpl"));
        }
